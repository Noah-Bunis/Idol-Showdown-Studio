...
public class PalleteCreatorIna : EditorWindow
{
    ...
    public PalleteCreatorIna()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Ina", false, 4)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorIna), true, "Pallete Editor");
    }
