...
public class PalleteCreatorSora : EditorWindow
{
    ...
    public PalleteCreatorSora()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Sora", false, 7)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorSora), true, "Pallete Editor");
    }
