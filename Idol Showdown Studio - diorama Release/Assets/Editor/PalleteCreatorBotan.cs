...
public class PalleteCreatorBotan : EditorWindow
{
    ...
    public PalleteCreatorBotan()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Botan", false, 2)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorBotan), true, "Pallete Editor");
    }
