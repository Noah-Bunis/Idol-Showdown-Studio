...
public class PalleteCreatorKoyori : EditorWindow
{
    ...
    public PalleteCreatorKoyori()
    {
        minSize = new Vector2(275, 275);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Koyori", false, 4)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorKoyori), true, "Pallete Editor");
    }
    ...
    private void OnGUI()
    {
        ...
        if (!waitForClear)
        {
            ...
            if (displayCharName != "Koyori")
            {
                ...
                displayChar = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/PaletteImages/Koyori.png", typeof(Texture2D));
                displayCharRef = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/PaletteImages/KoyoriRef.png", typeof(Texture2D));
