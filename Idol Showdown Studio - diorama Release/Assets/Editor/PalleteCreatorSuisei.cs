...
public class PalleteCreatorSuisei : EditorWindow
{
    ...
    public PalleteCreatorSuisei()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Suisei", false, 8)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorSuisei), true, "Pallete Editor");
    }
