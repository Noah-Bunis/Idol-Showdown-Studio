...
public class PalleteCreatorAyame : EditorWindow
{
    ...
    public PalleteCreatorAyame()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Ayame", false, 1)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorAyame), true, "Pallete Editor");
    }
