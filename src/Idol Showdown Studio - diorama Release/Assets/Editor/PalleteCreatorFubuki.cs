...
public class PalleteCreatorFubuki : EditorWindow
{
    ...
    public PalleteCreatorFubuki()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Fubuki", false, 4)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorFubuki), true, "Pallete Editor");
    }
