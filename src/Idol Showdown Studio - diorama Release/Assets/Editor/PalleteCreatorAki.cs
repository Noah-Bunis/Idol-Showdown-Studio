...
public class PalleteCreatorAki : EditorWindow
{
    ...
    public PalleteCreatorAki()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Aki", false, 0)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorAki), true, "Pallete Editor");
    }
    ...
    private static void ImportPallete(List<string> outColour)
    {
