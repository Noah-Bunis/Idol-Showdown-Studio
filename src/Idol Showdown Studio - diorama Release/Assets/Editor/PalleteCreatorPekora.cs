...
public class PalleteCreatorPekora : EditorWindow
{
    ...
    public PalleteCreatorPekora()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Pekora", false, 6)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorPekora), true, "Pallete Editor");
    }
    ...
    private void OnGUI()
    {
        ...
        if (!waitForClear)
        {
            ...
            if (displayCharName != "Pekora")
            {
                displayCharName = "Pekora";

                displayChar = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/PaletteImages/Pekora.png", typeof(Texture2D));
                displayCharRef = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/PaletteImages/PekoraRef.png", typeof(Texture2D));
