...
public class PalleteCreatorKorone : EditorWindow
{
    ...
    public PalleteCreatorKorone()
    {
        minSize = new Vector2(450, 450);
        maxSize = new Vector2(450, 450);
    }

    [MenuItem("Idol Showdown/Palette Editor (Old)/Korone", false, 5)]
    public static void PalleteWindow()
    {
        ...
        GetWindow(typeof(PalleteCreatorKorone), true, "Pallete Editor");
    }
